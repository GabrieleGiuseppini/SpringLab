...
***************************************************************************************/
#include "FSByPointGaussSeidelSimulator.h"

#include <array>
#include <cassert>

FSByPointGaussSeidelSimulator::FSByPointGaussSeidelSimulator(
    Object const & object,
...
void FSByPointGaussSeidelSimulator::OnStateChanged(
    Object const & object,
    SimulationParameters const & simulationParameters)
{
    CreateState(object, simulationParameters);
...
void FSByPointGaussSeidelSimulator::Update(
    Object & object,
...
void FSByPointGaussSeidelSimulator::CreateState(
    Object const & object,
    SimulationParameters const & simulationParameters)
{
...
void FSByPointGaussSeidelSimulator::ApplySpringsForcesAndIntegrate(
    Object & object,
    SimulationParameters const & simulationParameters)
{
    float const dt = simulationParameters.Common.SimulationTimeStepDuration / static_cast<float>(simulationParameters.FSCommonSimulator.NumMechanicalDynamicsIterations);
