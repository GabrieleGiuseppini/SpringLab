...
void LoadAndVerify(char const * functionName, TFunc * & pFunc, GLADloadproc load)
{
    ...
    if (nullptr == pFunc)
    {
        throw SLabException(std::string("OpenGL function '") + functionName + "' is not supported");
    }
}
...
void InitOpenGLExt_Framebuffer(GLADloadproc load)
{
    ...
    {
        throw SLabException("Framebuffer functionality is not supported");
    }
}
...
void InitOpenGLExt_DrawInstanced(GLADloadproc load)
{
    ...
    {
        throw SLabException("Instanced Drawing functionality is not supported");
    }
}
...
void InitOpenGLExt_VertexArray(GLADloadproc load)
{
    ...
    {
        throw SLabException("VAO functionality is not supported");
    }
}
...
void InitOpenGLExt_TextureFloat(GLADloadproc /*load*/)
{
    ...
    {
        throw SLabException("Texture Float functionality is not supported");
    }
}
