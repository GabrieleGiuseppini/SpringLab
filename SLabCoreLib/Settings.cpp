    ...
    for (auto const & filepath : mFileSystem->ListFiles(directoryPath))
    {
        try
        {
            ...
            if (std::regex_match(filename, filenameMatch, SettingsFilenameRegex))
            {
                ...
                {
                    throw SLabException("JSON settings could not be loaded: root value is not an object");
                }
    ...
    , mSettingsVersion(Version::CurrentVersion())
{
    ...
    {
        throw SLabException("JSON settings could not be loaded: missing 'version' attribute");
    }
    ...
    {
        throw SLabException("JSON settings could not be loaded: missing 'settings' attribute");
    }
